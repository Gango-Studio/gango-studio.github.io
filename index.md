<html>
  ...
  <body>
    <h1 style = "background-image: linear-gradient(to right,blue,orange);-webkit-background-clip: text; color: transparent;" align = "center">LIBERECO! Ni Estas La HONOJ</h1>
